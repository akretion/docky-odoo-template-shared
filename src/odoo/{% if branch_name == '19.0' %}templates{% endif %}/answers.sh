...
declare -x AUTH_IMPORT_API_BRIDGE_URL="${AUTH_IMPORT_API_BRIDGE_URL:-https://ais.akretion.com}"
declare -x AUTH_IMPORT_API_BRIDGE_LOGIN="${AUTH_IMPORT_API_BRIDGE_LOGIN:-}"
declare -x AUTH_IMPORT_API_BRIDGE_PASSWORD="${AUTH_IMPORT_API_BRIDGE_PASSWORD:-}"
declare -x SUPERPDP_CLIENT_ID="${SUPERPDP_CLIENT_ID:-}"
